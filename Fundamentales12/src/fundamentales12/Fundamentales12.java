 ...
 * recordemos que la fecha de nacimiento debe guardarse en un Date y los guarda
 * en el objeto.
 *
 ...
 *
 * • Método mostrarPersona(): este método muestra la persona creada en el método
 * anterior.
 */
public class Fundamentales12 {
    ...
    public static void main(String[] args) {
        ...
        int a = ps.calcularEdad(p);

        System.out.println(p.getNombre() + " tiene " + a + " años.");
