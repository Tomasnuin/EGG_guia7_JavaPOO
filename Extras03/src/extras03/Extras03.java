...
/**
 * 3. Vamos a realizar una clase llamada Raices, donde representaremos los
 * valores de una ecuación de 2o grado. Tendremos los 3 coeficientes como
...
public class Extras03 {
    ...
    public static void main(String[] args) {
        RaicesService raS = new RaicesService();
        
        Raices ra = raS.crearRaices();
